...
---@param path string path of the Spritter file without extension
---@param spritter SpritterOutput
---@return table filenames string or table of filenames for each sprite sheet generated by Spritter
util.filenames_from_spritter = function(path, spritter)
  if spritter.file_count == 1 then
    return {path .. ".png"}
  end
