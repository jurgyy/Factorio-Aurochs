...
function new_rail_pictures(rail_type)
  ...
  local elems =
  {
    ...
    { "stone_path_background",        "__aurochs__/graphics/rail-dirt-path.png"                                        },
...
function new_rail_remnants_pictures(rail_type)
  ...
  local elems =
  {
    ...
    { "stone_path_background", "__aurochs__/graphics/rail-dirt-path.png"                                                         , allow_forced_downscale = true }
  }
